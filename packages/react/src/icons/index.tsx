  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        ...
        {/* Dorsal fin */}
        <path
          d="M8.5 7.5c2-2.5 5-2.5 7 0-2.5.5-4.5.5-7 0z"
          fill="url(#fj-fish-fin)"
        />
        {/* Main Body */}
        <path
    ...
    {variant === 'outline' ? (
      ...
      <>
        ...
        <path
          ...
          opacity="0.9"
        />
        <ellipse cx="9" cy="8" rx="2.5" ry="1.2" fill="#ffffff" opacity="0.85" transform="rotate(-30 9 8)" />
        {/* Bottom Caustic Reflection */}
        <ellipse cx="14" cy="16.5" rx="3.5" ry="1" fill="#7dd3fc" opacity="0.6" transform="rotate(-15 14 16.5)" />
        {/* Tiny Companion Bubble */}
        <circle cx="19" cy="5.5" r="2" fill="url(#fj-bubble-bg)" stroke="#7dd3fc" strokeWidth="0.5" />
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        ...
        {/* Gloss highlight */}
        <ellipse cx="10.5" cy="9.8" rx="2.2" ry="1.1" fill="#ffffff" opacity="0.65" transform="rotate(-20 10.5 9.8)" />
      </>
    )}
  </svg>
);
...
export const IconGlobe: React.FC<IconProps> = ({
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        <circle cx="12" cy="12" r="9.5" fill="url(#fj-globe-ocean)" stroke="#0369a1" strokeWidth="0.75" />
        {/* Meridians and parallels in translucent aqua green */}
        <ellipse cx="12" cy="12" rx="5" ry="9.2" fill="none" stroke="#6ee7b7" strokeWidth="0.8" opacity="0.7" />
        <line x1="2.8" y1="12" x2="21.2" y2="12" stroke="#6ee7b7" strokeWidth="0.8" opacity="0.7" />
        <ellipse cx="12" cy="7.5" rx="7.5" ry="2.2" fill="none" stroke="#6ee7b7" strokeWidth="0.7" opacity="0.5" />
        <ellipse cx="12" cy="16.5" rx="7.5" ry="2.2" fill="none" stroke="#6ee7b7" strokeWidth="0.7" opacity="0.5" />
        {/* Specular gloss top */}
        <ellipse cx="9.5" cy="6.5" rx="4.5" ry="2" fill="#ffffff" opacity="0.55" transform="rotate(-20 9.5 6.5)" />
      </>
    )}
  </svg>
);
...
export const IconRainbow: React.FC<IconProps> = ({
  ...
  >
    {variant === 'outline' ? (
      <>
        <path d="M22 17a10 10 0 0 0-20 0" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path d="M18 17a6 6 0 0 0-12 0" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path d="M14 17a2 2 0 0 0-4 0" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      </>
    ) : (
      <>
        {/* Red/Orange Arc */}
        <path d="M22 18a10 10 0 0 0-20 0" stroke="#f87171" strokeWidth="2.2" strokeLinecap="round" />
        {/* Yellow/Green Arc */}
        ...
        {/* Blue Arc */}
        <path d="M13.5 18a1.5 1.5 0 0 0-3 0" stroke="#38bdf8" strokeWidth="1.8" strokeLinecap="round" />
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        ...
        />
        {/* Specular Glint */}
        <ellipse cx="9" cy="14" rx="1.5" ry="3" fill="#ffffff" opacity="0.4" transform="rotate(-20 9 14)" />
      </>
    )}
  </svg>
);
...
export const IconAeroOrb: React.FC<IconProps> = ({
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        {/* Outer Chrome Rim */}
        <circle cx="12" cy="12" r="10" fill="url(#fj-orb-chrome)" stroke="#334155" strokeWidth="0.5" />
...
export const IconDisc: React.FC<IconProps> = ({
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        {/* Base CD Platter */}
        <circle cx="12" cy="12" r="9.5" fill="url(#fj-cd-sheen)" stroke="#cbd5e1" strokeWidth="0.75" />
        {/* Concentric Sheen Rings */}
        <circle cx="12" cy="12" r="7.5" fill="none" stroke="#ffffff" strokeWidth="0.6" opacity="0.6" />
        <circle cx="12" cy="12" r="5.5" fill="none" stroke="#ffffff" strokeWidth="0.4" opacity="0.4" />
...
export const IconMonitor: React.FC<IconProps> = ({
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        {/* Bezel */}
        <rect x="2" y="3" width="20" height="13" rx="2" fill="#334155" stroke="#64748b" strokeWidth="0.75" />
        ...
        <ellipse cx="12" cy="20" rx="5" ry="1.5" fill="#94a3b8" stroke="#64748b" strokeWidth="0.5" />
      </>
    )}
  </svg>
);
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        ...
        <ellipse cx="10.5" cy="12" rx="1.5" ry="0.8" fill="#ffffff" opacity="0.8" transform="rotate(-30 10.5 12)" />
      </>
    )}
  </svg>
);
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        ...
        <path d="M18.5 6a8.5 8.5 0 0 1 0 12" stroke="#0ea5e9" strokeWidth="2" strokeLinecap="round" />
      </>
    )}
  </svg>
);
  ...
  >
    ...
    {variant === 'outline' ? (
      <>
        ...
        <line x1="23" y1="11" x2="23" y2="13" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      </>
    ) : (
      <>
        <rect x="1.5" y="6" width="17" height="12" rx="2.5" fill="#1e293b" stroke="#64748b" strokeWidth="0.75" />
  ...
  >
    {variant === 'outline' ? (
      <>
        ...
        <line x1="12" y1="20" x2="12.01" y2="20" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
      </>
    ) : (
      <>
        <path d="M1.5 8.5a16 16 0 0 1 21 0" stroke="#0ea5e9" strokeWidth="2.5" strokeLinecap="round" />
        <path d="M5 12a11 11 0 0 1 14 0" stroke="#38bdf8" strokeWidth="2.5" strokeLinecap="round" />
        <path d="M8.5 15.5a6 6 0 0 1 7 0" stroke="#7dd3fc" strokeWidth="2.5" strokeLinecap="round" />
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        ...
        <path
          d="M12 3.2L5.5 5.8V12c0 4.8 5.5 8.2 6.5 8.9V3.2z"
          fill="#ffffff"
          opacity="0.35"
        />
        <path
...
export const IconCompass: React.FC<IconProps> = ({
  ...
  >
    ...
    {variant === 'outline' ? (
      <>
        <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2" />
        <polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
      </>
    ) : (
      <>
        <circle cx="12" cy="12" r="9.5" fill="url(#fj-compass-dial)" stroke="#475569" strokeWidth="0.75" />
...
export const IconTrash: React.FC<IconProps> = ({
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        {/* Lid */}
        <rect x="2.5" y="5" width="19" height="2" rx="1" fill="#64748b" stroke="#334155" strokeWidth="0.5" />
        <path d="M9 5V3.5a1.5 1.5 0 0 1 1.5-1.5h3A1.5 1.5 0 0 1 15 3.5V5" stroke="#64748b" strokeWidth="1.5" />
        {/* Glass Bin Body */}
        <path
        ...
        />
        {/* Glass ribs */}
        <line x1="9.5" y1="9" x2="10" y2="19" stroke="#ffffff" strokeWidth="1" strokeLinecap="round" opacity="0.6" />
        <line x1="14.5" y1="9" x2="14" y2="19" stroke="#ffffff" strokeWidth="1" strokeLinecap="round" opacity="0.6" />
      </>
    )}
  </svg>
);
...
export const IconMusic: React.FC<IconProps> = ({
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        <path d="M9 18V4l12-2v14" stroke="url(#fj-music-grad)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        <circle cx="6" cy="18" r="3.2" fill="url(#fj-music-grad)" stroke="#0284c7" strokeWidth="0.5" />
        <circle cx="18" cy="16" r="3.2" fill="url(#fj-music-grad)" stroke="#0284c7" strokeWidth="0.5" />
        <ellipse cx="5" cy="17.2" rx="1.5" ry="0.8" fill="#ffffff" opacity="0.6" transform="rotate(-30 5 17.2)" />
        <ellipse cx="17" cy="15.2" rx="1.5" ry="0.8" fill="#ffffff" opacity="0.6" transform="rotate(-30 17 15.2)" />
      </>
    )}
  </svg>
);
...
export const IconPause: React.FC<IconProps> = ({
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        <rect x="6" y="4" width="4" height="16" rx="1.5" fill="url(#fj-pause-grad)" stroke="#0369a1" strokeWidth="0.5" />
        <rect x="14" y="4" width="4" height="16" rx="1.5" fill="url(#fj-pause-grad)" stroke="#0369a1" strokeWidth="0.5" />
    ...
    {variant === 'outline' ? (
      ...
      <>
        ...
        <path
          ...
          strokeWidth="0.5"
        />
        <path d="M6 19.5c1-2.5 3-4 6-4s5 1.5 6 4" stroke="#ffffff" strokeWidth="0.8" opacity="0.4" />
      </>
    )}
  </svg>
);
...
export const IconMail: React.FC<IconProps> = ({
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        <rect x="2.5" y="4.5" width="19" height="15" rx="2" fill="url(#fj-mail-grad)" stroke="#94a3b8" strokeWidth="0.75" />
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        ...
        <ellipse cx="8" cy="7.5" rx="3" ry="1.5" fill="#ffffff" opacity="0.65" transform="rotate(-30 8 7.5)" />
      </>
    )}
  </svg>
);
...
export const IconSearch: React.FC<IconProps> = ({
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        <circle cx="10.5" cy="10.5" r="7.5" fill="url(#fj-search-glass)" stroke="#0284c7" strokeWidth="1.5" />
        <ellipse cx="8.5" cy="7.5" rx="2.5" ry="1" fill="#ffffff" opacity="0.8" transform="rotate(-30 8.5 7.5)" />
        <line x1="21" y1="21" x2="15.8" y2="15.8" stroke="#475569" strokeWidth="3" strokeLinecap="round" />
        <line x1="21" y1="21" x2="16.5" y2="16.5" stroke="#94a3b8" strokeWidth="1.5" strokeLinecap="round" />
      </>
    )}
  </svg>
);
  ...
  >
    {variant === 'outline' ? (
      ...
      <>
        ...
        <polyline points="20 6 9 17 4 12" stroke="#bbf7d0" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
      </>
    )}
  </svg>
);
  ...
  >
    {variant === 'outline' ? (
      ...
      <>
        ...
        <line x1="18" y1="6" x2="6" y2="18" stroke="#fca5a5" strokeWidth="1.2" strokeLinecap="round" />
      </>
    )}
  </svg>
);
...
export const IconInfo: React.FC<IconProps> = ({
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        <circle cx="12" cy="12" r="9.5" fill="url(#fj-info-grad)" stroke="#0369a1" strokeWidth="0.75" />
        <ellipse cx="12" cy="6.5" rx="5" ry="2" fill="#ffffff" opacity="0.5" />
        <line x1="12" y1="16" x2="12" y2="11.5" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" />
    ...
    {variant === 'outline' ? (
      ...
      <>
        <path
          ...
          strokeLinejoin="round"
        />
        <line x1="12" y1="9" x2="12" y2="14" stroke="#451a03" strokeWidth="2" strokeLinecap="round" />
...
export const IconChevronDown: React.FC<IconProps> = ({ size = 20, className = '', ...props }) => (
  <svg {...getDims(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`fj-icon ${className}`} {...props}>
...
export const IconDownload: React.FC<IconProps> = ({
  ...
  >
    {variant === 'outline' ? (
      ...
      <>
        <path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2" stroke="#0284c7" strokeWidth="2" strokeLinecap="round" />
        <path d="M12 3v11m0 0l-4-4m4 4l4-4" stroke="#0ea5e9" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
      </>
    )}
  </svg>
);
...
export const IconUpload: React.FC<IconProps> = ({
  ...
  >
    {variant === 'outline' ? (
      ...
      <>
        <path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2" stroke="#0284c7" strokeWidth="2" strokeLinecap="round" />
        <path d="M12 15V4m0 0l-4 4m4-4l4 4" stroke="#0ea5e9" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
      </>
    )}
  </svg>
);
...
export const IconEye: React.FC<IconProps> = ({
  ...
  >
    {variant === 'outline' ? (
      ...
      <>
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" fill="#f0f9ff" stroke="#0284c7" strokeWidth="1.2" />
...
export const IconClock: React.FC<IconProps> = ({
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        <circle cx="12" cy="12" r="9.5" fill="url(#fj-clock-dial)" stroke="#0284c7" strokeWidth="0.75" />
        <polyline points="12 6.5 12 12 15.5 14" stroke="#0f172a" strokeWidth="1.8" strokeLinecap="round" />
...
export const IconCalendar: React.FC<IconProps> = ({
  ...
  >
    ...
    {variant === 'outline' ? (
      ...
      <>
        {/* Calendar Body */}
        <rect x="3" y="4" width="18" height="17" rx="2" fill="#ffffff" stroke="#cbd5e1" strokeWidth="0.75" />
        {/* Red Gloss Header */}
...
export const IconLayers: React.FC<IconProps> = ({
  ...
  >
    {variant === 'outline' ? (
      ...
      <>
        <polygon points="12 3 21 7.5 12 12 3 7.5" fill="#38bdf8" stroke="#0284c7" strokeWidth="0.75" opacity="0.9" />
        <polygon points="12 3 21 7.5 12 12" fill="#ffffff" opacity="0.3" />
        <polyline points="3 12 12 16.5 21 12" stroke="#0284c7" strokeWidth="1.8" strokeLinejoin="round" />
        <polyline points="3 16.5 12 21 21 16.5" stroke="#0369a1" strokeWidth="1.8" strokeLinejoin="round" />
      </>
    )}
  </svg>
);
